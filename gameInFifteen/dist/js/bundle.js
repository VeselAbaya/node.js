...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  view: document.querySelector('.view'),\n  timer: document.querySelector('.content__panel--timer'),\n  restart: document.querySelector('.content__panel--restart')\n});\n\n//# sourceURL=webpack:///./src/js/base.js?");
...
/*!*******************************!*\
  !*** ./src/js/controllers.js ***!
  \*******************************/
/*! exports provided: clickControl, touchControl, keyControl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clickControl\", function() { return clickControl; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"touchControl\", function() { return touchControl; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"keyControl\", function() { return keyControl; });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./src/js/base.js\");\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constants */ \"./src/js/constants.js\");\n/* harmony import */ var _animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animation */ \"./src/js/animation.js\");\n\n\n\nvar current_empty_pos = 16;\nvar arrow_code = {\n  left: 37,\n  up: 38,\n  right: 39,\n  down: 40\n};\n\nvar isNear = function isNear(pos) {\n  var available_poss = [pos - 1, pos + 1, pos - 4, pos + 4];\n  return available_poss.includes(current_empty_pos);\n};\n\nvar clickControl = function clickControl() {\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"default\"].view.addEventListener('click', function (e) {\n    var block_pos = +e.target.closest('.view__block').dataset.pos;\n\n    if (isNear(block_pos)) {\n      var empty_block = document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos, \"\\\"]\"));\n      var block = e.target;\n      empty_block.innerHTML = block.innerHTML;\n      block.innerHTML = '';\n      var block_id = e.target.id;\n      block.id = empty_block.id;\n      empty_block.id = block_id;\n      current_empty_pos = block_pos;\n    }\n  });\n};\nvar touchControl = function touchControl() {\n  document.addEventListener('touchstart', handleTouchStart, false);\n  document.addEventListener('touchmove', handleTouchMove, false);\n  var xDown = null;\n  var yDown = null;\n\n  function getTouches(evt) {\n    return evt.touches;\n  }\n\n  function handleTouchStart(evt) {\n    xDown = getTouches(evt)[0].clientX;\n    yDown = getTouches(evt)[0].clientY;\n  }\n\n  function handleTouchMove(evt) {\n    if (!xDown || !yDown) {\n      return;\n    }\n\n    var xUp = evt.touches[0].clientX;\n    var yUp = evt.touches[0].clientY;\n    var xDiff = xDown - xUp;\n    var yDiff = yDown - yUp;\n\n    if (Math.abs(xDiff) > Math.abs(yDiff)) {\n      /*most significant*/\n      if (xDiff > 0) {\n        if (current_empty_pos % _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size !== 0) {\n          var block = document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos + 1, \"\\\"]\"));\n          Object(_animation__WEBPACK_IMPORTED_MODULE_2__[\"moveBlock\"])(block, 'left');\n        }\n      } else {\n        if (current_empty_pos % _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size !== 1) {\n          var _block = document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos - 1, \"\\\"]\"));\n\n          Object(_animation__WEBPACK_IMPORTED_MODULE_2__[\"moveBlock\"])(_block, 'right');\n        }\n      }\n    } else {\n      if (yDiff > 0) {\n        if (current_empty_pos <= _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size * (_constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size - 1)) {\n          var _block2 = document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos + 4, \"\\\"]\"));\n\n          Object(_animation__WEBPACK_IMPORTED_MODULE_2__[\"moveBlock\"])(_block2, 'up');\n        }\n      } else {\n        if (current_empty_pos > _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size) {\n          var _block3 = document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos - 4, \"\\\"]\"));\n\n          Object(_animation__WEBPACK_IMPORTED_MODULE_2__[\"moveBlock\"])(_block3, 'down');\n        }\n      }\n    }\n    /* reset values */\n\n\n    xDown = null;\n    yDown = null;\n  }\n};\nvar keyControl = function keyControl() {\n  document.addEventListener('keyup', function (e) {\n    switch (e.keyCode) {\n      case arrow_code.left:\n        if (current_empty_pos % _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size !== 0) {\n          var block = document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos + 1, \"\\\"]\"));\n          Object(_animation__WEBPACK_IMPORTED_MODULE_2__[\"moveBlock\"])(block, 'left');\n        }\n\n        break;\n\n      case arrow_code.up:\n        if (current_empty_pos <= _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size * (_constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size - 1)) {\n          var _block4 = document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos + 4, \"\\\"]\"));\n\n          Object(_animation__WEBPACK_IMPORTED_MODULE_2__[\"moveBlock\"])(_block4, 'up');\n        }\n\n        break;\n\n      case arrow_code.right:\n        if (current_empty_pos % _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size !== 1) {\n          var _block5 = document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos - 1, \"\\\"]\"));\n\n          Object(_animation__WEBPACK_IMPORTED_MODULE_2__[\"moveBlock\"])(_block5, 'right');\n        }\n\n        break;\n\n      case arrow_code.down:\n        if (current_empty_pos > _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size) {\n          var _block6 = document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos - 4, \"\\\"]\"));\n\n          Object(_animation__WEBPACK_IMPORTED_MODULE_2__[\"moveBlock\"])(_block6, 'down');\n        }\n\n        break;\n    }\n  });\n};\n\nvar restartController = function restartController() {\n  for (var i = 0; i !== 1000; ++i) {\n    var e = Math.ceil(Math.random() * 100 % 4);\n\n    switch (e) {\n      case 0:\n        if (current_empty_pos % _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size !== 0) document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos + 1, \"\\\"]\")).click();\n        break;\n\n      case 1:\n        if (current_empty_pos <= _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size * (_constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size - 1)) document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos + 4, \"\\\"]\")).click();\n        break;\n\n      case 2:\n        if (current_empty_pos % _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size !== 1) document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos - 1, \"\\\"]\")).click();\n        break;\n\n      case 3:\n        if (current_empty_pos > _constants__WEBPACK_IMPORTED_MODULE_1__[\"default\"].grid_size) document.querySelector(\"[data-pos=\\\"\".concat(current_empty_pos - 4, \"\\\"]\")).click();\n        break;\n    }\n  }\n};\n\n//# sourceURL=webpack:///./src/js/controllers.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./src/js/base.js\");\n/* harmony import */ var _controllers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controllers */ \"./src/js/controllers.js\");\n/* harmony import */ var _models_timer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/timer */ \"./src/js/models/timer.js\");\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants */ \"./src/js/constants.js\");\n\n\n\n\nvar timer = new _models_timer__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n\nvar generateField = function generateField() {\n  for (var i = 1; i !== _constants__WEBPACK_IMPORTED_MODULE_3__[\"default\"].block_amount + 1; ++i) {\n    var markup = \"\\n      <div class=\\\"view__block\\\" id=\\\"\".concat(i, \"\\\" data-pos=\\\"\").concat(i, \"\\\">\\n        <span>\").concat(i !== 16 ? i : '', \"</span>\\n      </div>  \\n    \");\n    _base__WEBPACK_IMPORTED_MODULE_0__[\"default\"].view.insertAdjacentHTML('beforeend', markup);\n  }\n};\n/* CONTROLLER */\n\n\nwindow.onload = function (e) {\n  timer.on();\n  generateField();\n  Object(_controllers__WEBPACK_IMPORTED_MODULE_1__[\"clickControl\"])();\n  Object(_controllers__WEBPACK_IMPORTED_MODULE_1__[\"keyControl\"])();\n  Object(_controllers__WEBPACK_IMPORTED_MODULE_1__[\"touchControl\"])();\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"default\"].restart.addEventListener('click', function () {\n    timer.time = 0;\n    restartController();\n  }); // TODO think about it\n  // document.addEventListener('visibilitychange', (e) => {\n  //   console.log('lol')\n  //   if (!timerId) {\n  //     timerId = timerOn()\n  //   } else {\n  //     clearInterval(timerId)\n  //     timerId = null\n  //   }\n  // })\n\n  window.addEventListener('blur', function () {\n    timer.off();\n  });\n  window.addEventListener('focus', function () {\n    if (!timer.work()) timer.on();\n  });\n  window.addEventListener('beforeunload', function (e) {\n    localStorage.setItem('time', time);\n  });\n};\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Timer; });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../base */ \"./src/js/base.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar Timer =\n/*#__PURE__*/\nfunction () {\n  function Timer() {\n    var time = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;\n\n    _classCallCheck(this, Timer);\n\n    this.time = time;\n    this.timerId = null;\n  }\n\n  _createClass(Timer, [{\n    key: \"on\",\n    value: function on() {\n      var _this = this;\n\n      this.timerId = setInterval(function () {\n        _base__WEBPACK_IMPORTED_MODULE_0__[\"default\"].timer.innerHTML = \"timer \".concat(Timer.formatTime(_this.time));\n        ++_this.time;\n      }, 1000);\n    }\n  }, {\n    key: \"off\",\n    value: function off() {\n      clearInterval(this.timerId);\n      this.timerId = null;\n    }\n  }, {\n    key: \"work\",\n    value: function work() {\n      return this.timerId !== null;\n    }\n  }, {\n    key: \"getTime\",\n    get: function get() {\n      return this.time;\n    }\n  }, {\n    key: \"setTime\",\n    set: function set(time) {\n      this.time = time;\n      _base__WEBPACK_IMPORTED_MODULE_0__[\"default\"].timer.innerHTML = \"timer \".concat(this.formatTime(this.time));\n    }\n  }], [{\n    key: \"formatTime\",\n    value: function formatTime(time) {\n      var minutes = Math.floor(time / 60);\n      var seconds = time % 60;\n      var formatted_min = minutes < 10 ? \"0\".concat(minutes) : \"\".concat(minutes);\n      var formatted_sec = seconds < 10 ? \"0\".concat(seconds) : \"\".concat(seconds);\n      return \"\".concat(formatted_min, \":\").concat(formatted_sec);\n    }\n  }]);\n\n  return Timer;\n}();\n\n\n\n//# sourceURL=webpack:///./src/js/models/timer.js?");
